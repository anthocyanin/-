...
(
    select
        from_unixtime(unix_timestamp()-3600*24,'yyyyMMdd') as ds,
        p1.product_cname1 as product_cname1,
        p1.product_cname2 as product_cname2,
        ...
        (---自营的商品毛利额计算
            ...
            ( 
                ...
                (
                    ...
                    where 
                        s1.ds = from_unixtime(unix_timestamp()-3600*24,'yyyyMMdd')
                    and 
                        s2.ds = from_unixtime(unix_timestamp()-3600*24,'yyyyMMdd')
                    and
                        s2.platform = 14
                ) t1
                left join 
                ...
                (
                    ...
                    (
                        ...
                        (
                            ...
                            where 
                                ds=from_unixtime(unix_timestamp()-3600*24,'yyyyMMdd')
                        ) s1
                        inner join
                        (
                            select
                ...
                (
                    ...
                    (
                        ...
                        where 
                            ds= from_unixtime(unix_timestamp()-3600*24,'yyyyMMdd') 
                        and 
                            from_unixtime(ob_ctime,'yyyyMMdd')>= from_unixtime(unix_timestamp()-3600*48,'yyyyMMdd')
                    ) s1
                    inner join
                    (
                        select
            ...
            (
                ...
                where ds=from_unixtime(unix_timestamp()-3600*24,'yyyyMMdd')
            ) n2
...
group by h1.ds,h1.product_cname1,h1.product_cname2
